...
{
	// misc
	private static final String TAG   = "MediaPlayerTest.FaceDetection.Settings";
	...
	// decoder
	public  int 	decoderType = 1;				// 0 - soft, 1 - hard stagefright, 2 - hybrid mode h/w decoder + OpenGL rendering.  
