...
public class MainActivity extends Activity implements OnClickListener, MediaPlayer.MediaPlayerCallback, SurfaceHolder.Callback2
{
	...
	private AbsoluteLayout playerRow1 = null;
...
//		externalView.getHolder().addCallback(this);
		...
		playerRow1 = (AbsoluteLayout)findViewById(R.id.playerRow1);
...
//		GridLayout parent = (GridLayout)findViewById(R.id.playerView);
//		
//		GridLayout.LayoutParams params = (GridLayout.LayoutParams) player1.getLayoutParams();
//	    params.width = (parent.getWidth()/parent.getColumnCount()) -params.rightMargin - params.leftMargin;
//	    player1.setLayoutParams(params);		
//	
//		params = (GridLayout.LayoutParams) player2.getLayoutParams();
//	    params.width = (parent.getWidth()/parent.getColumnCount()) -params.rightMargin - params.leftMargin;
//	    player2.setLayoutParams(params);		
	    ...
	    //player1.getSurfaceView().setZOrderOnTop(true);    // necessary
		//SurfaceHolder sfhTrackHolder = player1.getSurfaceView().getHolder();
		//sfhTrackHolder.setFormat(PixelFormat.TRANSPARENT);
		
	   // player2.getSurfaceView().setZOrderOnTop(true);    // necessary
		//sfhTrackHolder = player2.getSurfaceView().getHolder();
		//sfhTrackHolder.setFormat(PixelFormat.TRANSPARENT);

	    //player3.getSurfaceView().setZOrderOnTop(true);    // necessary
		//sfhTrackHolder = player3.getSurfaceView().getHolder();
		//sfhTrackHolder.setFormat(PixelFormat.TRANSPARENT);

	    //player4.getSurfaceView().setZOrderOnTop(true);    // necessary
		//sfhTrackHolder = player4.getSurfaceView().getHolder();
		//sfhTrackHolder.setFormat(PixelFormat.TRANSPARENT);
...
//    	    		player.setSurface(surface, false);
//    	    	}
