...
public class MainActivity extends Activity implements OnClickListener, MediaPlayer.MediaPlayerCallback
{
    ...
    public void onCreate(Bundle savedInstanceState) 
	{
		...
		strUrl = settings.getString("connectionUrl", "rtsp://admin:Ferris101@96.66.132.246:9554");
		

		HashSet<String> tempHistory = new HashSet<String>();
		tempHistory.add("rtsp://admin:Ferris101@96.66.132.246:9554");
		tempHistory.add("rtsp://admin:q1w2e3r4t5@91.216.211.70:20555");
