...
{
	// misc
	private static final String TAG   = "MediaPlayerSDKTest.LowLatency.Settings";
	...
	public  int connectionDetectionTime = 300;// in milliseconds
	public  int connectionBufferingTime = 3000;	// in milliseconds

	// decoder
	public  int 	decoderType = 1;				// 0 - software decoder, 1 - hardware decoder

	// renderer
	public  int 	lowLatency = 1;					// 0 - OFF, 1 - ON
	public  int 	rendererEnableAspectRatio = 1; 	// 0 - resize, 1 - aspect
	
	// synchro
	public  int 	synchroEnable = 0;				// enable audio video synchro
	public  int 	TCP 		  = 1;				// 0 - UDP, 1 - TCP
 	...
 	public void loadPrefSettings() 
	{
		// load preferences settings to local variables
 		...
 		connectionDetectionTime = settings.getInt("connectionDetectionTime", 300);
 		...
 		lowLatency 					= settings.getInt("lowLatency", 1);
 		rendererEnableAspectRatio 	= settings.getInt("rendererEnableAspectRatio", 1);
 		synchroEnable				= settings.getInt("synchroEnable", 0);
		TCP							= settings.getInt("TCP", 0);
