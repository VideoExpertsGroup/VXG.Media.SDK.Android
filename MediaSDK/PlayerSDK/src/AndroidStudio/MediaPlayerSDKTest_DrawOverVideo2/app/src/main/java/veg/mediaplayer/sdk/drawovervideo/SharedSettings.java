...
public class SharedSettings 
{
	...
	// decoder
	public  int 	decoderType = 0;				// 0 - soft, 1 - hard stagefright
	...
	public boolean getBooleanValueForKey(final String key) 
	{
		...
		Log.e(TAG, "getBooleanValueForKey " + key + ":" + settings.getBoolean(key, false));
 	...
 	public long getLongValueForKey(final String key) 
	{
		...
		Log.e(TAG, "getLongValueForKey " + key + ":" + settings.getLong(key, 0));
 	...
 	public int getIntValueForKey(final String key) 
	{
		...
		Log.e(TAG, "getIntValueForKey " + key + ":" + settings.getInt(key, 0));
